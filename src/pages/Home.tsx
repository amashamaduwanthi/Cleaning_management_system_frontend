    ...
    return (
        <>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 m-4">
                ...
                {/*                        <span*/}
                {/*                            className="font-semibold text-teal-800">Booking ID:</span> {bookingDetails.bookingId}*/}
                {/*                    </p>*/}
                {/*                    <p className="text-base text-gray-700">*/}
                {/*                        <span*/}
                {/*                            className="font-semibold text-teal-800">Date:</span> {bookingDetails.date}*/}
                {/*                    </p>*/}

                {/*                    <p className="text-base text-gray-700">*/}
                {/*                        <span className="font-semibold text-teal-800">Service Type</span> {bookingDetails.serviveId}*/}
                {/*                    </p>*/}
                {/*                </div>*/}
                {/*            </div>*/}
